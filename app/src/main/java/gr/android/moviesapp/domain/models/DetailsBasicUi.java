...
public class DetailsBasicUi {
    ...
    public DetailsBasicUi(String backdropPath, List<GenreUi> genres, int id, String overview, String posterPath, String releaseDate, String title, double voteAverage, String homepage, int runtime, boolean isFavorite) {
